...
#
# v.1.1 - Also allows other people to prompt you to act with !slap, !give and !make
#
# Location for slap phrases: (Change username)
$file = "/home/USERNAME/.config/hexchat/addons/objects.txt";
# For Windows
...
#================== End of user config===========
$flslap_version = "1.1";
Xchat::register( "Slaper for HexChat", $flslap_version, "/give, /make and /slap", "" );
Xchat::print "Loading Slaper $flslap_version";
